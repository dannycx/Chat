        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mDeleteBtnState == 0) {
                    ...
                    FriendViewHolder viewHolder = (FriendViewHolder) getChildViewHolder(view);
                    mItemLayout = viewHolder.mFriendItemRoot;
                    mPosition = viewHolder.getAdapterPosition();
                    mAccount = viewHolder.mFriendAccount.getText().toString();
                    mDelete = mItemLayout.findViewById(R.id.huanxin_friend_item_delete);
...
//                    mMaxLength = mDelete.getWidth() * 2;
                    ...
                    mDelete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            mListener.onDeleteClick(mAccount, mPosition);
